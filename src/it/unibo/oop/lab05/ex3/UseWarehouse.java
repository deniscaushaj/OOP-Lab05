...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
        ...
        final Product p1 = new ProductImpl("Mele", 3.0);
        final Product p2 = new ProductImpl("Stelle", 1.0);
        final Product p3 = new ProductImpl("Pere", 5.0);

        final Warehouse w = new WarehouseImpl(new HashSet<>());
        w.addProduct(p3);
        w.addProduct(p1);
        w.addProduct(p2);
